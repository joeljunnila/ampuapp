...
public class MainActivity extends AppCompatActivity {
    ...
    public void addFileNames() {
        imageFileNames.add("ohje1.jpg");
        imageFileNames.add("ohje2.jpg");
        imageFileNames.add("ohje2B.jpg");
        imageFileNames.add("ohje3.jpg");
        imageFileNames.add("ohje4.jpg");
        imageFileNames.add("ohje5.jpg");
        imageFileNames.add("ohje5B.jpg");
        imageFileNames.add("ohje6.jpg");
        imageFileNames.add("ohje6B.jpg");
        imageFileNames.add("ohje7.jpg");
        imageFileNames.add("ohje8.jpg");
        imageFileNames.add("ohje8B.jpg");
        imageFileNames.add("ohje9.jpg");
        imageFileNames.add("ohje9B.jpg");
        imageFileNames.add("ohje10.jpg");
        ...
        imageFileNames.add("kuvat/ohje1.jpg");
        imageFileNames.add("kuvat/ohje2.jpg");
        imageFileNames.add("kuvat/ohje2B.jpg");
        imageFileNames.add("kuvat/ohje3.jpg");
        imageFileNames.add("kuvat/ohje4.jpg");
        imageFileNames.add("kuvat/ohje5.jpg");
        imageFileNames.add("kuvat/ohje5B.jpg");
        imageFileNames.add("kuvat/ohje6.jpg");
        imageFileNames.add("kuvat/ohje6B.jpg");
        imageFileNames.add("kuvat/ohje7.jpg");
        imageFileNames.add("kuvat/ohje8.jpg");
        imageFileNames.add("kuvat/ohje8B.jpg");
        imageFileNames.add("kuvat/ohje9.jpg");
        imageFileNames.add("kuvat/ohje9B.jpg");
        imageFileNames.add("kuvat/ohje10.jpg");
    ...
    public void synnytyksenAikanaSivu2(View v) {
        ...
        imageView.setImageBitmap(getImage("ohje1.jpg"));
    ...
    public void synnytyksenAikanaSivu3(View v) {
        ...
        imageArea.setVisibility(View.VISIBLE);
        imageView.setImageBitmap(getImage("ohje2.jpg"));
    ...
    public void synnytyksenAikanaSivu4(View v) {
        ...
        imageArea.setVisibility(View.VISIBLE);
        imageView.setImageBitmap(getImage("ohje2B.jpg"));
    ...
    public void peratilaSivu3(View v) {
        ...
        imageArea.setVisibility(View.VISIBLE);
        imageView.setImageBitmap(getImage("ohje5B.jpg"));
    ...
    public void peratilaSivu4(View v) {
        ...
        imageArea.setVisibility(View.VISIBLE);
        imageView.setImageBitmap(getImage("ohje6.jpg"));
    ...
    public void peratilaSivu5(View v) {
        ...
        imageArea.setVisibility(View.VISIBLE);
        imageView.setImageBitmap(getImage("ohje6B.jpg"));
    ...
    public void hartiadystokiaSivu2(View v) {
        ...
        imageArea.setVisibility(View.VISIBLE);
        imageView.setImageBitmap(getImage("ohje8.jpg"));
    ...
    public void hartiadystokiaSivu3(View v) {
        ...
        imageArea.setVisibility(View.VISIBLE);
        imageView.setImageBitmap(getImage("ohje8B.jpg"));
    ...
    public void napanuoraSivu1(View v) {
        ...
        imageArea.setVisibility(View.VISIBLE);
        imageView.setImageBitmap(getImage("ohje9.jpg"));
    ...
    public void napanuoraSivu2(View v) {
        ...
        imageArea.setVisibility(View.VISIBLE);
        imageView.setImageBitmap(getImage("ohje9B.jpg"));
    ...
    public void napanuoraSivu3(View v) {
        ...
        imageArea.setVisibility(View.VISIBLE);
        imageView.setImageBitmap(getImage("ohje10.jpg"));
